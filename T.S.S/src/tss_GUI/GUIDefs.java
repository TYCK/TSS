...
public class GUIDefs
{
	...
	final public static Color BOLD_TEXT_COLOR = new Color(20, 21, 170);
	final public static Color COMMON_TEXT_COLOR = new Color(30, 43, 131);
	final public static Font BASE_HEADING_FONT = new Font("Verdana",Font.BOLD,14);
